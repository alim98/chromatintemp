...
# We're not using neurofire/inferno anymore, using a pure PyTorch implementation instead
echo "Using PyTorch-based texture models (no neurofire/inferno required)"
