...
# Install MONAI for texture models (replacing neurofire/inferno)
echo "Installing MONAI for texture models..."
pip install monai || echo "MONAI installation failed, continuing without it"
