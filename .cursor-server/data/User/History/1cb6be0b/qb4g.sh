...
if [ ! -f "data/metadata.csv" ]; then
  echo "Creating sample metadata.csv..."
  echo "sample_id,class_id,class_name" > data/metadata.csv
  echo "sample1,0,class_a" >> data/metadata.csv
  echo "sample2,0,class_a" >> data/metadata.csv
  echo "sample3,1,class_b" >> data/metadata.csv
  echo "sample4,1,class_b" >> data/metadata.csv
fi
